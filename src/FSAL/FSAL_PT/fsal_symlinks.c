                                ...
                                struct attrlist * p_link_attributes) /* IN/OUT */
{
  ...
  fsal_readlink_by_handle(p_context, dir_hdl->export, pt_hdl->handle, p_link_content,
                              *link_len);
                           ...
                           struct attrlist * p_link_attributes)    /* IN/OUT */
{
  ...
  rc = symlinkat(p_linkcontent, mount_fd, p_linkname);
  ...
  rc = fchownat(mount_fd, p_linkname, p_context->creds->caller_uid,
  ...
  if(p_link_attributes) {
      status = PTFSAL_getattrs(dir_hdl->export, p_context, p_link_handle,
                                 p_link_attributes);
