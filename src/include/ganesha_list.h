...
/*
 * @brief Comparer routine that is used by glist_insert_sorted
 *
 * This routine can be defined by the calling function
 * to enable a sorted insert
 *
 * @param struct glist_head *: This first element to compare
 * @param struct glist_head *: The second element to compare
 * @param arg: optional user defined arg
 *
 ...
 */
typedef int (*glist_compare) (struct glist_head *,
			      struct glist_head *,
			      void *);
